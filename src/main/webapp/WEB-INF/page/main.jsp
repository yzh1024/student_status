...
<script>
    ...
    layui.use(['echarts'], function () {
        ...
        var echartRecord = echarts.init(document.getElementById("container1"));
        option = {
            tooltip:{
                show:true
            },
        ...
        echartRecord.setOption(option);

        var echartRecord2 = echarts.init(document.getElementById("container2"));
        option2 = {
            tooltip:{
                show:true
            },
        ...
        echartRecord2.setOption(option2);
