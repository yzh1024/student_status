        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="year" value="${section.year}" lay-verify="required" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="type" lay-verify="required">
                        ...
                        <option value="春季" <c:if test="${section.type == '春季'}">selected</c:if>>春季</option>
                        <option value="秋季" <c:if test="${section.type == '秋季'}">selected</c:if>>秋季</option>
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                    ...
                    <select name="teacherId" lay-verify="required">
                        ...
                        <c:forEach items="${teachers}" var="teacher">
                            <option value="${teacher.id}"
                                    <c:if test="${section.teacherId == teacher.id }">selected</c:if>>${teacher.teacherName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
                    ...
                    <select name="courseId" lay-verify="required">
                        ...
                        <c:forEach items="${courses}" var="course">
                            <option value="${course.id}"
                                    <c:if test="${section.courseId == course.id }">selected</c:if>>${course.courseName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="remark" value="${section.remark}" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
...
<script src="${basePath}static/lib/layui-v2.5.5/layui.js?<%=System.currentTimeMillis()%>" charset="utf-8"></script>
